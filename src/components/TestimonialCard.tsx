...
export function TestimonialCard({ item }: { item: Testimonial | Review }) {
  ...
  return (
    <div className="flex flex-col items-start gap-4 rounded-2xl border border-neutral-100 p-6">
      <PlaceholderImage label={item.name} rounded className="h-16 w-16 shrink-0" />
